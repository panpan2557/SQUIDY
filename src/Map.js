var Map = cc.Node.extend({
	ctor: function( gameLayer ) {
		...
		this.createFirstStageInstruction();

		this.setAnchorPoint( cc.p( 0, 0 ) );
	},

	createSpriteArray: function() {
		this.wallSprite = [];
		this.coinSprite = [];
		this.checkPoint = [];
		this.urchin = [];
	...
	createFirstStageInstruction: function() {
	...
	removeSprite: function() {
		this.removeWallSprite();
		this.removeCheckPoint();
		this.removeUrchin();
		this.removeBonusTime();
	},
